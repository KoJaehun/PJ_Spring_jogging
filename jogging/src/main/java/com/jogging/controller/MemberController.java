...
import com.jogging.service.mail.MailService;
import com.jogging.service.member.MemberService;
...
@SessionAttributes({"memberDTO"}) 	// 공유영역
@Slf4j
...
public class MemberController {
	...
	@ModelAttribute("memberDTO")     // 초기화하는 작업
